...
class AnimatedSpinbox(QFrame):
    def __init__(self, min_val=0, max_val=59, initial_val=0, unit="", right_margin=2, parent=None):
        ...
        self.unit_label.setStyleSheet("color: #FFB300; font-family: 'Segoe UI', Tahoma, sans-serif; font-weight: bold; font-size: 12px; border: none; background: transparent; padding-bottom: 1px;")
...
class Popup(QWidget):
    ...
    def _build_time_card_section(self, layout):
        ...
        colon1 = QLabel(":")
        colon1.setStyleSheet("color: #FFB300; font-family: 'Segoe UI', Tahoma, sans-serif; font-weight: bold; font-size: 16px; background: transparent; border: none;")
        ...
        colon2 = QLabel(":")
        colon2.setStyleSheet("color: #FFB300; font-family: 'Segoe UI', Tahoma, sans-serif; font-weight: bold; font-size: 16px; background: transparent; border: none;")
